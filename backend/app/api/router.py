...
from app.api.routes import achievements, ai, auth, cards, decks, enhance, import_export, mental_map, shop, study, users
...
api_router.include_router(enhance.router, prefix="/mental-maps", tags=["mental-maps"])
