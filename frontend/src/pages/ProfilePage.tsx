      ...
      <div className="animate-fade-in">
        ...
        <div style={{ 
          ...
          <div className="stat-card" style={{ 
            ...
            <div className="stat-label">Days Learning</div>
          </div>
        </div>

        {/* Profile Form */}
        <Card className="card-dark">
          <h2 style={{ marginBottom: "24px", fontSize: "1.5rem" }}>Account Settings</h2>
        ...
        <Card className="card-dark" style={{ marginTop: "24px" }}>
          <h3 style={{ marginBottom: "16px", fontSize: "1.25rem" }}>Quick Actions</h3>
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            <Link to="/shop">
              <Button variant="primary" size="sm">Visit Shop</Button>
            </Link>
            <Link to="/inventory">
              <Button variant="secondary" size="sm">My Inventory</Button>
            </Link>
            <Link to="/decks">
              <Button variant="secondary" size="sm">My Decks</Button>
            </Link>
          </div>
        </Card>
        ...
        {/* Account Info */}
        <Card className="card-dark" style={{ marginTop: "24px" }}>
          <h3 style={{ marginBottom: "16px", fontSize: "1.25rem" }}>Account Information</h3>
